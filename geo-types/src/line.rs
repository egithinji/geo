    ...
    T: ::num_traits::Float + ::rstar::RTreeNum,
{
    ...
    fn envelope(&self) -> Self::Envelope {
        ...
        ::rstar::AABB::from_corners(bounding_rect.min(), bounding_rect.max())
    }
}
...
where
    T: ::num_traits::Float + ::rstar::RTreeNum,
{
    fn distance_2(&self, point: &Coordinate<T>) -> T {
        let d = crate::private_utils::point_line_euclidean_distance(Point::from(*point), *self);
        d.powi(2)
    }
}
